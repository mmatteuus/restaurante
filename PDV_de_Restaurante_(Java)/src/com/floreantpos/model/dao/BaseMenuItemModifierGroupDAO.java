 ...
 */
public abstract class BaseMenuItemModifierGroupDAO extends com.floreantpos.model.dao._RootDAO {
	...
	public static MenuItemModifierGroupDAO getInstance () {
		if (null == instance) instance = new MenuItemModifierGroupDAO();
		return instance;
	}

	public Class getReferenceClass () {
		return com.floreantpos.model.MenuItemModifierGroup.class;
	}
	...
	/**
	 * Cast the object as a com.floreantpos.model.MenuItemModifierGroup
	 */
	public com.floreantpos.model.MenuItemModifierGroup cast (Object object) {
		return (com.floreantpos.model.MenuItemModifierGroup) object;
	}
...
/* Generic methods */
	 ...
	 */
	public java.util.List<com.floreantpos.model.MenuItemModifierGroup> findAll () {
	 ...
	 * Return all objects related to the implementation of this DAO with no filter.
	 */
	public java.util.List<com.floreantpos.model.MenuItemModifierGroup> findAll (Order defaultOrder) {
	 ...
	 * @param s the Session
	 */
	public java.util.List<com.floreantpos.model.MenuItemModifierGroup> findAll (Session s, Order defaultOrder) {
	 ...
	 * @param menuItemModifierGroup a transient instance of a persistent class 
